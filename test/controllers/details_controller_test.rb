...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { name: @detail.name, phone: @detail.phone, user_id: @detail.user_id } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { name: @detail.name, phone: @detail.phone, user_id: @detail.user_id } }
